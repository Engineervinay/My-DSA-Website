...
function Accordion({ open, toggle, title, desc, id }) {
  ...
  return (
    <div className="pt-[10px]  ">
      <div
        className="bg-cyan-400 bg-opacity-10 rounded-lg py-[25px] px-[50px] flex justify-between items-center cursor-pointer"
        onClick={toggle}
      >

...
function SubAccordion({
  ...
  return (
    <div className="pt-[10px]">
      <div
        className="bg-cyan-400 bg-opacity-10 rounded-t-lg py-[25px] px-[50px] flex justify-between items-center cursor-pointer"
        onClick={toggle}
      >
        ...
        <div className="text-[27px] flex space-x-3 ">
          ...
          <a href={gfg} target="_blank" rel="noreferrer">
            {" "}
            <SiGeeksforgeeks />
          </a>

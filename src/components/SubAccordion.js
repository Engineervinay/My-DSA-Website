...
import {AiFillFileText,AiOutlineMinus,AiOutlinePlus,AiOutlineYoutube} from "react-icons/ai"
...
function SubAccordion({open,toggle,name,gfg,leetcode,article,youtube,code}) {
  ...
  return (
    <div className='pt-[10px]'>
      <div className="bg-white bg-opacity-10 rounded-t-lg py-[25px] px-[50px] flex justify-between items-center cursor-pointer" onClick={toggle}>
      ...
      <Collapse isOpened={open}>
        ...
        <div className='bg-white bg-opacity-10 rounded-b-lg px-[50px] pb-[20px] '>
        <CopyBlock
    text={code}
    language={"cpp"}
